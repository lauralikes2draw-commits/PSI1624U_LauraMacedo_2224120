...
{
    public partial class DetalheMarcacaoClienteForm : Form
    {
        private readonly int idMarcacao;
        private ClienteMarcacaoInfo marcacao;

        public DetalheMarcacaoClienteForm()
        {
            this.idMarcacao = 0;
            InitializeComponent();
        }
        ...
        private void Montar()
        {
            ...
            cancelar.Click += CancelarMarcacao_Click;
        ...
        private void CancelarMarcacao_Click(object sender, EventArgs e)
        {
