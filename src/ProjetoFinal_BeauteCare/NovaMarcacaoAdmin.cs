...
{
    public partial class NovaMarcacaoAdmin : Form
    {
        private int passo = 1;
        ...
        private void RenderizarPassoClienteData()
        {
            ...
            btnCliente.Tag = false;
            btnAdmin.Tag = true;
            btnCliente.Click += EscolhaDestinoAdmin_Click;
            btnAdmin.Click += EscolhaDestinoAdmin_Click;
        ...
        private void RenderizarPassoServicos()
        {
            ...
            foreach (string cat in cats)
            {
                ...
                chip.Tag = cat;
                chip.Click += CategoriaAdmin_Click;
        ...
        private Control CriarCardProfissional(AdminProfissional p)
        {
            ...
            card.Tag = p;
            card.Click += ProfissionalAdmin_Click;
            ...
            esp.Tag = p;
            esp.Click += ProfissionalAdmin_Click;
        ...
        private void EscolhaDestinoAdmin_Click(object sender, EventArgs e)
        {
            Control controle = sender as Control;
            if (controle == null || !(controle.Tag is bool)) return;
            paraMimAdmin = (bool)controle.Tag;
            RenderizarPasso();
        }

        private void CategoriaAdmin_Click(object sender, EventArgs e)
        {
            Control controle = sender as Control;
        ...
        private void ServicoAdmin_Click(object sender, EventArgs e)
        {
            Control controle = sender as Control;
            AdminServico servico = controle == null ? null : controle.Tag as AdminServico;
            if (servico == null) return;

            AdminServico existente = servicosSelecionados.Find(x => x.IdServico == servico.IdServico);
            if (existente == null) servicosSelecionados.Add(servico);
            else servicosSelecionados.Remove(existente);
            RenderizarPasso();
        }

        private void ProfissionalAdmin_Click(object sender, EventArgs e)
        {
            Control controle = sender as Control;
            AdminProfissional profissional = controle == null ? null : controle.Tag as AdminProfissional;
