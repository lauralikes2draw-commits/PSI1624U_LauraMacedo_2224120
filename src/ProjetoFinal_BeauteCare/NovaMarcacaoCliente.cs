...
{
    public partial class NovaMarcacaoCliente : Form
    {
        private int passo = 1;
        ...
        public NovaMarcacaoCliente()
        {
            this.idCliente = 0;
            this.idServicoInicial = null;
            InitializeComponent();
            VincularEventosFixos();
        }
        ...
        private void VincularEventosFixos()
        {
        ...
        private Guna2Button CriarChipCategoria(string texto, bool ativo)
        {
            ...
            chip.Tag = texto;
            chip.Click += CategoriaCliente_Click;
            return chip;
        }
        ...
        private Control CriarCardServico(ServicoInfo s)
        {
            ...
            btn.Tag = s;
            btn.Click += ServicoCliente_Click;
        ...
        private void MontarPassoProfissionalData()
        {
            ...
            dtp.Width = 145;
            dtp.ValueChanged += DataCliente_ValueChanged;
            ...
            horas.SelectedIndexChanged += HoraCliente_SelectedIndexChanged;
        ...
        private Control CriarCardProfissional(ProfissionalInfo p)
        {
            ...
            card.Tag = p;
            card.Click += ProfissionalCliente_Click;
            ...
            foto.Tag = p;
            foto.Click += ProfissionalCliente_Click;
        ...
        private void MontarPassoPagamento()
        {
            ...
            foreach (string m in metodos)
            {
                ...
                b.Click += MetodoPagamentoCliente_Click;
            ...
            aplicar.Tag = txtCupao;
            aplicar.Click += AplicarCupaoCliente_Click;
        ...
        private void CategoriaCliente_Click(object sender, EventArgs e)
        {
            Control controle = sender as Control;
            string categoria = controle == null ? null : controle.Tag as string;
            if (string.IsNullOrWhiteSpace(categoria)) return;
            categoriaAtual = categoria;
            MontarPasso();
        }

        private void ServicoCliente_Click(object sender, EventArgs e)
        {
            Control controle = sender as Control;
            ServicoInfo servico = controle == null ? null : controle.Tag as ServicoInfo;
            if (servico == null) return;

            if (selecionados.Any(x => x.IdServico == servico.IdServico))
                selecionados.RemoveAll(x => x.IdServico == servico.IdServico);
            else
        ...
        private void DataCliente_ValueChanged(object sender, EventArgs e)
        {
        ...
        private void HoraCliente_SelectedIndexChanged(object sender, EventArgs e)
        {
            ComboBox horas = sender as ComboBox;
            if (horas == null || horas.SelectedItem == null) return;
            horaSelecionada = TimeSpan.Parse(horas.SelectedItem.ToString());
            idProfissionalSelecionado = 0;
            MontarPasso();
        }

        private void ProfissionalCliente_Click(object sender, EventArgs e)
        {
            Control controle = sender as Control;
            ProfissionalInfo profissional = controle == null ? null : controle.Tag as ProfissionalInfo;
            if (profissional == null) return;
            idProfissionalSelecionado = profissional.IdUsuario;
            MontarPasso();
        }

        private void MetodoPagamentoCliente_Click(object sender, EventArgs e)
        {
            Control controle = sender as Control;
            string novoMetodo = controle == null ? null : controle.Tag as string;
            if (string.IsNullOrWhiteSpace(novoMetodo)) return;
            metodo = novoMetodo;
            MontarPasso();
        }

        private void AplicarCupaoCliente_Click(object sender, EventArgs e)
        {
            Control controle = sender as Control;
            Guna2TextBox txtCupao = controle == null ? null : controle.Tag as Guna2TextBox;
            if (txtCupao == null) return;
            ...
            try
            {
                ...
                if (c == null)
                {
                    MessageBox.Show("Cupão inválido, usado ou expirado.", "BeauteCare");
                    return;
                }
